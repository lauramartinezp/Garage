...
public class ControladorGarajeImpl implements ControladorGaraje{
	...
	@Override
	public void guardarVehiculo() throws GarajeException {
		...
		try {			
			...
			VehiculoDaoJDBC daoVehiculo=new VehiculoDaoJDBCImpl();
	...
	public void borrarVehiculo() throws GarajeException {
		...
		daoVehiculo.delete(in.nextLine());
	...
	public void mostrarVehiculo() throws GarajeException {
		...
		try {
			...
			System.out.println(daoVehiculo.read(matricula).convierteAFormatoTxt());
	...
	@Override
	public void listarVehiculo() throws GarajeException {

	try {
		VehiculoDaoJDBC daoVehiculo=new VehiculoDaoJDBCImpl();
		
		List<Vehiculo> vehiculos = daoVehiculo.readVehiculos();
